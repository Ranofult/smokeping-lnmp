...
2. 执行 `bash -c "$(curl -L https://raw.githubusercontent.com/Ranofult/smokeping-lnmp/main/install.sh)"`。Nginx 站点配置文件目录为 `/www/server/panel/vhost/nginx`；Nginx fastcgi_params 目录为 `/www/server/nginx/conf`。
